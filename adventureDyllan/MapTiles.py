...
class EnemyRoom(MapTile):
	...
	def modify_player(self, the_player):
		...
		Input:
			the_player <Player>
		"""	
		if self.enemy.out_of_guesses():
			the_player.move(dx = random.randint(1,10), dy = random.randint(1,10))

			the_player.guesses_remaining -= 1
...
class TestQuestionRoom(EnemyRoom):
	"""
	...
	"""
	def __init__(self, x, y):
		super().__init__(x,y,Enemies.TestQuestion())
	...
	def intro_text(self):
		...
		"""
		if (self.enemy.is_alive()):
			intro_description = ("You have wandered into a {} type room!\nYour question is {}".format(self.enemy.subject, self.enemy.question))

		else:
			intro_description = ("You sense you answered a {} question in here!\n".format(self.enemy.subject))

		return intro_description



class RandomAdditionMathQuestionRoom(EnemyRoom):
	"""
	A subclass of EnemyRoom, contains a GiantSpider
	...
	"""
	def __init__(self, x, y):
		super().__init__(x,y,Enemies.RandomAdditionMathQuestion())
...
class RandomSubtractionMathQuestionRoom(EnemyRoom):
	"""
	A subclass of EnemyRoom, contains a GiantSpider
	...
	"""
	def __init__(self, x, y):
		super().__init__(x,y,Enemies.RandomSubtractionMathQuestion())
...
class RandomMultiplicationMathQuestionRoom(EnemyRoom):
	"""
	A subclass of EnemyRoom, contains a GiantSpider
	...
	"""
	def __init__(self, x, y):
		super().__init__(x,y,Enemies.RandomMultiplicationMathQuestion())
...
class RandomDivisionMathQuestionRoom(EnemyRoom):
	"""
	A subclass of EnemyRoom, contains a GiantSpider
	...
	"""
	def __init__(self, x, y):
		super().__init__(x,y,Enemies.RandomDivisionMathQuestion())
...
class FillInRoom(EnemyRoom):
	...
	"""
	def __init__(self, x, y):
		super().__init__(x,y,Enemies.FillInQuestion())
