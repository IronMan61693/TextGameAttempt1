...
# new_world.extend(["RandomMultiplicationMathQuestionRoom"]*2)
# new_world.extend(["RandomDivisionMathQuestionRoom"]*2)
...
possibleTilesSet = {"Find5GoldRoom", "EmptyCavePath", "TestQuestionRoom", "RandomAdditionMathQuestionRoom", "RandomDivisionMathQuestionRoom"}
possibleTilesSet.add("RandomMultiplicationMathQuestionRoom")
possibleTilesSet.add("RandomSubtractionMathQuestionRoom")
